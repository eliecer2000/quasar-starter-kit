  ...
  prompts: {
    ...
    typescriptConfig: {
      ...
      choices: [
        ...
        {
          name: "Class-based [DEPRECATED, see https://github.com/quasarframework/quasar/discussions/11204] (https://github.com/vuejs/vue-class-component)",
          value: "class",
          short: "Class",
          disabled: true
        }
    ...
    createRole: {
      type: "list",
      message: "Continue to create aws role project",
      choices: [
        {
          name: "Yes, create role (recommended)",
          value: true,
          short: "yes"
        },
        {
